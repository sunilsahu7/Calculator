...
Multiply=Button(root, padx=16, bd=8, fg="black", font=('arial', 20,'bold'), text="*").grid(row=3, column=4)
# 3rd line

btn0=Button(root, padx=16, pady=16, command=lambda:btnCLick(0), bd=8, fg="black", font=('arial', 20,'bold'), text="0").grid(row=4, column=0)
btnC=Button(root, padx=16, pady=16, bd=8, fg="black", font=('arial', 20,'bold'), text="C").grid(row=4, column=1)
btn11=Button(root, padx=16, pady=16, bd=8, fg="black", font=('arial', 20,'bold'), text="=").grid(row=4, column=2)
Division=Button(root, padx=16, pady=16, bd=8, fg="black", font=('arial', 20,'bold'), text="/").grid(row=4, column=4)
# 4th line
